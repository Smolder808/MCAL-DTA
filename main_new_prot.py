...
if __name__ == '__main__':
    ...
    parser.add_argument('--running_set', type=str, help='new_prot', default='new_prot')
    ...
    for fold_i in range(kfold):  
        ...
        valid_target_graphs_dict = load_pickle(f'{dataset_path}fold_{fold_i}_valid_prot_data.pkl')
